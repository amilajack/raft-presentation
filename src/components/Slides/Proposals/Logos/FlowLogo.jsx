...
const FlowLogo = props => (
  <svg className={'flow-logo'} viewBox={'0 0 498.39 252.33'} {...props}>
    <g className={'flow-logo-mark'}>
      ...
      <path
        ...
        opacity={0.7}
        d={
          'M101.47 168.23l-84.1-84.12h84.11v84.11zm90.58-42.57L125 58.57h67.08zm7.84 118.84l-76.28-76.27h76.28z'
        }
      />
      <path fill={'#fcbc7c'} opacity={0.9} d={'M101.47 67l-67-67h67z'} />
      <path
        fill={'#f9a040'}
        opacity={0.8}
        d={'M123.95 168.22l84.11 84.11h-84.11z'}
      />
      <path fill={'#f9a040'} opacity={0.7} d={'M209.08 201.8l-84-84h84z'} />
      <path fill={'#ffcf39'} opacity={0.9} d={'M125 58.57l83.09 83.09H125z'} />
      <path
        fill={'#ffc737'}
        opacity={0.7}
